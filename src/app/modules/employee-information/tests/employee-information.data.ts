...
export const employeeInformationData = (): EmployeeInformation => {
    return {
        id: "1234567890",
        gender: undefined,
...
export const createEmployeeInformationData = (): CreateEmployeeInformationDto => ({
    gender: undefined,
    maritalStatus: undefined,
    dateOfBirth: new Date('1990-01-01'),
    joinedDate: new Date('2020-01-01'),
...
export const paginationResultEmployeeInformationData = (): Pagination<CreateEmployeeInformationDto> => {
    return {
        items: [employeeInformationData()],
        meta: {
            totalItems: 1,
            itemCount: 1,
            itemsPerPage: 10,
