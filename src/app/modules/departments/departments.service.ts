...
export class DepartmentsService {
  constructor(@InjectRepository(Department) private departmentRepository: TreeRepository<Department>,
    private paginationService: PaginationService) {

  }
  async createDepartment(createDepartmentDto: CreateDepartmentDto, tenantId: string, parentDepartment?: Department, level = 0): Promise<Department> {
    try {
  ...
  async updateDepartment(
    ...
    parentDepartment?: Department, level = 0
  ): Promise<Department> {
    try {
