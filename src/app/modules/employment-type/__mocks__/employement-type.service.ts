...
import { employementTypeData, paginationResultEmploymentTypeData } from '../tests/employement-type.data';
...
export const UsersService = jest.fn().mockReturnValue({
    ...
    update: jest
        ...
        .mockImplementation((id) =>
            id === employementTypeData().id
                ? Promise.resolve(employementTypeData())
                : Promise.reject(new Error(`Employement type with id ${id} not found.`)),
        ),
