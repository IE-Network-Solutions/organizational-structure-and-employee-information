...
import { branchData, createbranchDataOnCreate, deletebranchData, findOneNotFoundReturnValue, paginationResultbranchData, updatebranchData } from "../tests/branch.data";
...
export const BranchesService = jest.fn().mockReturnValue({
    ...
    findAllBranchs: jest.fn().mockImplementation(
