...
import { deleteEmployeeJobInformationData, employeeJobInformationDataSave, paginationResultEmployeeJobInformationData } from '../employee-job-information/tests/employee-job-information.data';
