...
describe('EmployeeDocumentController', () => {
  ...
  beforeEach(async () => {
    ...
    employeeDocumentController = moduleRef.get<EmployeeDocumentController>(
  ...
  describe('findAll', () => {
    describe('when findAll is called', () => {
      ...
      test('then it should call EmployeeDocumentService', () => {
        expect(employeeDocumentService.findAll).toHaveBeenCalledWith(
          paginationOptions(),
        );
      });
    });
  ...
  describe('findOne', () => {
    describe('when findOne is called', () => {
      ...
      beforeEach(async () => {
        employeeDocument = await employeeDocumentController.findOne(
          employeeDocumentData().id,
        );
      });

      test('then it should call EmployeeDocumentService', () => {
        expect(employeeDocumentService.findOne).toHaveBeenCalledWith(
          employeeDocumentData().id,
        );
      });
    });
  ...
  describe('update', () => {
    describe('when update is called', () => {
      ...
      beforeEach(async () => {
        employeeDocument = await employeeDocumentController.update(
          employeeDocumentData().id,
          employeeDocumentData() as any,
        );
      });
  ...
  describe('remove', () => {
    describe('when remove is called', () => {
      ...
      test('then it should call EmployeeDocumentService', () => {
        expect(employeeDocumentService.remove).toHaveBeenCalledWith(
          employeeDocumentData().id,
        );
      });
