...
describe('EmployeeDocumentService', () => {
  ...
  describe('create', () => {
    describe('when create is called', () => {
      ...
      const uploadedDocumentPath = {
        viewImage: 'http://example.com/documents/employee-handbook.pdf',
      ...
      beforeEach(() => {
        ...
        employeeDocumentRepository.create.mockReturnValue(
          createEmployeeDocumentDto as any,
        );
        employeeDocumentRepository.save.mockResolvedValue(
          employeeDocumentDataSave() as any,
        );
      });
      ...
      it('should throw ConflictException on error', async () => {
        employeeDocumentRepository.save.mockRejectedValue(
          new Error('Conflict'),
        );
        await expect(
  ...
  describe('findOne', () => {
    describe('when findOne is called', () => {
      ...
      it('should call employeeDocumentRepository.createQueryBuilder', async () => {
        ...
        expect(
          employeeDocumentRepository.createQueryBuilder,
        ).toHaveBeenCalledWith('employee_document');
        expect(
          employeeDocumentRepository.createQueryBuilder().where,
        ).toHaveBeenCalledWith('employee_document.id = :id', { id });
      });
  ...
  describe('update', () => {
    describe('when update is called', () => {
      ...
      beforeEach(() => {
        employeeDocumentRepository.findOneOrFail.mockResolvedValue(
          employeeDocumentDataSave() as any,
        );
        employeeDocumentRepository.update.mockResolvedValue(
          updateEmployeeDocumentData() as any,
        );
        employeeDocumentRepository.findOneOrFail.mockResolvedValue(
          employeeDocumentDataSave() as any,
        );
      ...
      it('should call employeeDocumentRepository.findOneOrFail', async () => {
        ...
        expect(employeeDocumentRepository.findOneOrFail).toHaveBeenCalledWith({
          where: { id },
        });
      });
      ...
      it('should call employeeDocumentRepository.update', async () => {
        await employeeDocumentService.update(id, createEmployeeDocumentData());
        expect(employeeDocumentRepository.update).toHaveBeenCalledWith(
          { id },
          createEmployeeDocumentData(),
        );
      });
      ...
      it('should return the updated employee document', async () => {
        const result = await employeeDocumentService.update(
          id,
          createEmployeeDocumentData(),
        );
        expect(result).toEqual(employeeDocumentDataSave());
  ...
  describe('remove', () => {
    describe('when remove is called', () => {
      ...
      beforeEach(() => {
        ...
        employeeDocumentRepository.softDelete.mockResolvedValue({
          affected: 1,
        } as any);
      });
      ...
      it('should call employeeDocumentRepository.softDelete', async () => {
        await employeeDocumentService.remove(id);
        expect(employeeDocumentRepository.softDelete).toHaveBeenCalledWith({
          id,
        });
      });
