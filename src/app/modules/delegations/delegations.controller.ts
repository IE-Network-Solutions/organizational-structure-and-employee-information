...
export class DelegationController {
  ...
  @ExcludeAuthGuard()
  @Post()
  create(@Body() createDelegationDto: CreateDelegationDto,@Headers('tenantId') tenantId: string,) {
  ...
  findDelegationByLeaveRequestId(@Param('leaveRequestId') leaveRequestId: string, @Headers('tenantId') tenantId: string,
   
) {
    return this.delegationService.findDelegationByLeaveRequestId(leaveRequestId, tenantId);
  }
...
@ExcludeAuthGuard()
  ...
  updateDelegationByLeaveRequestId(@Param('leaveRequestId') leaveRequestId: string, @Body() updateDelegationDto: UpdateDelegationDto,@Headers('tenantId') tenantId: string,) {
    console.log(leaveRequestId,"leaveRequestId")
    console.log(updateDelegationDto,"updateDelegationDto")
    

    return this.delegationService.updateDelegationByLeaveRequestId(leaveRequestId, updateDelegationDto,tenantId);
  }
