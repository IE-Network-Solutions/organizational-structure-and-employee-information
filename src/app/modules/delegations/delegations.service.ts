...
export class DelegationService {
  ...
  async findDelegationByLeaveRequestId(
  ...
  async updateDelegationByLeaveRequestId(
    leaveRequestId: string,
    updateDelegationDto: UpdateDelegationDto,
    tenantId: string,
  ): Promise<Delegation> {
    try {
      const delegation = await this.findDelegationByLeaveRequestId(
        leaveRequestId,
        tenantId,
      );
      if (delegation) {
      ...
      return await this.findDelegationByLeaveRequestId(
        leaveRequestId,
        tenantId,
      );
    } catch (error) {
  ...
  async removeDelegationByRequestId(
    leaveRequestId: string,
    tenantId: string,
  ): Promise<Delegation> {
    try {
