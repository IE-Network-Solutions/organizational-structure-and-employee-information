...
import { EmployeeInformationSubscriber } from './modules/employee-information/subscribers/employee-information.subscriber';
import { SessionSubscriber } from './modules/session/subscribers/session.subscriber';
